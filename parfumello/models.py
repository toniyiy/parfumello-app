...
class PerfumeNote(models.Model):
    ...
    perfume = models.ForeignKey(
        "Perfume", on_delete=models.CASCADE, related_name="perfume_notes"
    )
    note = models.ForeignKey(
        Note, on_delete=models.CASCADE, related_name="perfume_notes"
    )
...
class Perfume(models.Model):
    ...
    display_photo = models.ImageField(
        upload_to="display_photos/", null=True, blank=True
    )
    ...
    kaggle_index = models.IntegerField(null=True, blank=True)
...
class OrderItem(models.Model):
    ...
    perfume = models.ForeignKey(
        Perfume, on_delete=models.SET_NULL, null=True, blank=True
    )
...
class UserReview(models.Model):
    perfume = models.ForeignKey(
        Perfume, on_delete=models.CASCADE, related_name="reviews"
    )
    user = models.ForeignKey(
